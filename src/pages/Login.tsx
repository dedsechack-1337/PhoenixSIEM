...
const s: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: 24, fontWeight: 800, color: '#f0f6ff', letterSpacing: '-0.02em', margin: 0, lineHeight: 1.2 },
  ...
  subtitle: { fontSize: 11, fontFamily: 'monospace', color: '#3d5a7a', margin: '6px 0 0', lineHeight: 1.4 },
  card: {
  ...
  authRow: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 26 },
  authTitle: { fontSize: 13, fontWeight: 600, color: '#f0f6ff', margin: 0, flex: 1, lineHeight: 1.3 },
  ...
  label: { display: 'block', fontSize: 10, fontWeight: 700, textTransform: 'uppercase' as const,
    letterSpacing: '0.1em', color: '#3d5a7a', marginBottom: 8, lineHeight: 1.4 },
  ...
  demoLabel: { fontSize: 9, fontWeight: 700, textTransform: 'uppercase' as const,
    letterSpacing: '0.12em', color: '#3d5a7a', marginBottom: 12, lineHeight: 1.4 },
  demoBtn: {
  ...
  demoUser: { fontSize: 12, fontFamily: 'monospace', fontWeight: 700, color: '#ff8c3a', lineHeight: 1.4 },
  demoPass: { fontSize: 10, fontFamily: 'monospace', color: '#3d5a7a', marginLeft: 8, lineHeight: 1.4 },
  demoRole: { fontSize: 10, color: '#3d5a7a', lineHeight: 1.4 },
  footer: { textAlign: 'center' as const, fontSize: 10, fontFamily: 'monospace', color: '#3d5a7a', marginTop: 24, lineHeight: 1.6 },
